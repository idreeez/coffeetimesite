    ...
    t = jQuery, a = {
        ...
        showProducts: function(s) {
            ...
            for (let n in s) {
                ...
                for (let a in s[n]) {
                    ...
                    if ("sbName" === a && (c.append(`<span>${s[n][a]}</span>`), p.val(s[n][a])), "sbSize" === a && void 0 !== s[n][a] && (c.children("span").append(`<span class="smart-basket__product-size">, ${s[n][a]}мл</span>`), d.val(s[n][a])), "sbPrice" === a && (_.html(s[n][a]), h.val(s[n][a])), "sbPriceCommon" === a) {
                        let t = +s[n][a];
                        y.val(+t.toFixed(2))
                    }
        ...
        stateBasket: function() {
            ...
            return e.getSmartBasketMinState(o), c.click(function() {
                ...
                if (void 0 !== r[n]) {
                    let a = t(this).html();
                    return t(this).text("В корзину"), t("body").append(e.alertBlock("alreadyAdded")), setTimeout(() => {
                        t(this).html(a)
                    }, 1500), !1
                } {
                    let i = {};
            ...
            if (a.agreement.isRequired) {
                ...
                let e = t("<label>").attr({
                    ...
                    s = t("<input>").attr({
                        ...
                        value: "Перед тем, как сделать заказ, проверьте правильно"
                    }),
                    r = null;
                r = a.agreement.isLink ? t("").attr({
                    ...
                    class: "smart-basket__link-agreement"
                }), s.is(":checked") ? r.text("Оплатить сейчас через SberPay") : r.text(""), e.click(function() {
                    s.is(":checked") ? (r.text(""), s.val(""), m.attr({
                        disabled: "disabled"
                    }), d.addClass("smart-basket__input-wrapper_error")) : (r.text("Оплатить сейчас через SberPay"), s.val("Оплатить сейчас через SberPay"), m.attr({
                        disabled: !1
        ...
        closeModalBasket(a) {
            a.click(a => {
                a.preventDefault(), t(".smart-basket").toggleClass("smart-basket_active"), t("body").css("overflow", "visible")
            })
        },
        sendCart: function() {
            ...
            t.ajax({
                ...
                complete: function(s) {
                    ...
                    e.commonResult(r, "", "submitEvent"), localStorage.clear(), "" !== a.yaCounter.counterID && "" !== a.yaCounter.targetID && ym(a.yaCounter.counterID, "reachGoal", a.yaCounter.targetID), setTimeout(() => {
                        t(".smart-basket").toggleClass("smart-basket_dontactive"), t("body").css("overflow", "visible")
                    }, 4000), setTimeout(() => {
        ...
        alertBlock: function(a) {
            ...
            let p = e.getProducts() || {};
            return e.getModalBasket(c, p), "inBasket" === a && (n.html('\n\t\t\t\t<svg class="" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2">\n         <circle class="path circle" fill="none" stroke="#75453E" stroke-width="6" stroke-miterlimit="10" cx="65.1" cy="65.1" r="62.1"/>\n         <polyline class="path check" fill="none" stroke="#75453E" stroke-width="6" stroke-linecap="round" stroke-miterlimit="10" points="100.2,40.2 51.5,88.8 29.8,67.5 "/>\n\t\t\t\t</svg>'), i.text("Товар добавлен в корзину")), "alreadyAdded" === a && (n.html('\n\t\t\t\t<svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2">\n          <circle class="path circle" fill="none" stroke="#75453E" stroke-width="6" stroke-miterlimit="10" cx="65.1" cy="65.1" r="62.1"/>\n          <line class="path line" fill="none" stroke="#75453E" stroke-width="6" stroke-linecap="round" stroke-miterlimit="10" x1="34.4" y1="37.9" x2="95.8" y2="92.3"/>\n          <line class="path line" fill="none" stroke="#75453E" stroke-width="6" stroke-linecap="round" stroke-miterlimit="10" x1="95.8" y1="38" x2="34.4" y2="92.2"/>\n\t\t\t\t</svg>\n\t\t\t\t'), i.append("Товар уже добавлен в корзину")), o.append(l).append(c), s.append(r.append(n).append(i).append(o)), s
        },
        init: function(s) {
            t.extend(a, s);
